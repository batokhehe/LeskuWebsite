...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-lg"><b>Les</b>ku</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Statistic Subject</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Statistic Teacher</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Report Teacher</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Report Student</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Report Subject</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Manage Slider</a></li>
