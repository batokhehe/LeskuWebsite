      ...
      <!--------------------------
        ...
        <div class="col-md-12">
          <div class="box">
		          ...
		          <h3 class="box-title">Data Table Reschedule</h3>
		        </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped table-responsive" width="100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if($study_class->student_status == '5'){ 
                                echo 'Reschedule'; 
                              } else if ($study_class->student_status == '4') {
                                echo 'Dikonfirmasi';
                              } else { echo 'Belum Dikonfirmasi'; } ?></td>
                    <td><?php if($study_class->status == '5'){ 
                                echo 'Reschedule'; 
                              } else if ($study_class->status == '4') {
                                echo 'Dikonfirmasi';
                              } else { echo 'Belum Dikonfirmasi'; } ?></td>
