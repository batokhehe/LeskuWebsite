...
<head>
	...
	<!-- //Meta-Tags -->
	<!-- Form -->
  <link href="{{ url('') }}/assets/css_1/form.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap-CSS -->
...
<body>
	...
	<div class="banner inner-banner-w3-agileits" id="home">
        ...
        <h2 class="inner-tittle-w3layouts"><?php echo $_SERVER['REQUEST_URI'] ?></h2>
			</div>
		</div>
	</div>
	<!-- //banner -->
	...
	<div class="footer w3layouts">
		<div class="container">
            ...
            <li><a href="/service" data-hover="Services">Services</a></li>
	...
	<script type="text/javascript" src="{{ url('') }}/assets/js_1/move-top.js"></script>
	<script type="text/javascript" src="{{ url('') }}/assets/js_1/easing.js"></script>
	<script type="text/javascript">
	...
	<script src="{{ url('') }}/assets/js_1/bootstrap.min.js"></script>
